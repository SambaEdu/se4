...
<?php
	if ($os=="8.0") { echo "Jessie"; } else { echo "Stretch"; } echo "<I> <img src=\"../elements/images/debian.png\">($os)</I></TD></TR>\n";
?>
	</TD>
	</TR>
	<TR>
...
//            echo '<TR>';
	...
	<TR>
		<TD>Etat du serveur Samba Version: <span id="smb_version" style="font-style: italic;">(<?php echo $smbversion . "AD" ?>)</span></TD>
		<TD align="center">
